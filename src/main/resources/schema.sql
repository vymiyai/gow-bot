...
create table if not exists public.discord_user (id  bigserial not null, access_token varchar(255), creation_date timestamp with time zone, discord_id int8, discord_username varchar(255), last_change timestamp with time zone, discord_resources_fk int8, primary key (id), description varchar(511));
